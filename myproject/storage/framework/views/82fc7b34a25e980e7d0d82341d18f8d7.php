            ...
            <div class="row-e">
                <div class="MainContent mb-20">
                    <div class="WelcomeTab">
                        ...
                        <p class="mb-0">Track your study abroad journey and manage your applications all in one place.</p>
                    </div>
                </div>
                <div class="pl-15 pr-15">
                    ...
                    <div class="row justify-content-between recentAct DashBMainTab mb-20">
                        <div class="row-half pr-15">
                            <div class="dashboardContent">
                                <h3 class="mb-20 recenT text-center">Recent Activity</h3>
                                <div class="recentDashboardWrapper mb-20">
                                    ...
                                    <a class="comBtn" href="#">View all Activites</a>
                            </div>
                        </div>
                        <div class="row-half">
                            <div class="dashboardContent docTitle newAction">
                                <h3 class="mb-15 quick">Quick Actions</h3>
                    ...
                    <div class="row justify-content-between  DashBMainTab align-items-center">
                        ...
                        <div class="row-half dashboardContent">
                            <div class="support-header">
                                <h3>Support Tickets</h3>
                                <button class="btn-create">+ New Ticket</button>
                            </div>
                            <div class="support-body">
                                ...
                                <div class="ticket-item">
                                    <span class="ticket-title">Course Enrollment</span>
                                    <span class="ticket-status closed">Closed</span>
                                </div>
                                <div class="ticket-item">
                                    <span class="ticket-title">Payment Confirmation</span>
                                    <span class="ticket-status open">Open</span>
                                </div>
                            </div>
                            <div class="support-footer">
                                <a class="comBtn" href="#" class="btn-view-all">View All</a>
                            </div>
                        </div>
                        <div class="row-half">
                            <div class="dashboardContent additionalServices">
                                <h3 class="recenT mb-20 text-center">Additional Services</h3>
                                <div class="service-item">
                                    <div class="serviceT">Smu University</div>
                                    <div class="service-title">Student Health Insurance - 12 months</div>
                                    <span class="service-status processing">Processing</span>
                                </div>
                                <div class="service-item">
                                    <div class="serviceT">Smu University</div>
                                    <div class="service-title">Study Visa Out of Country</div>
                                    <span class="service-status completed">Completed</span>
                                </div>
                                <div class="text-center mt-20">
                                    <a href="#" class="comBtn">View All</a>
                                </div>
                            </div>
                        </div>
                    </div>
