...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
  <div class="container">
    ...
    <a class="navbar-brand univImg" href="https://univs.in/app/">
      <img src="<?php echo e(asset('image/univs.webp')); ?>" alt="Logo" />
    </a>
...
<section class="firstSection overflow-hidden py-3">
  <div class="container px-4 my-5 text-center">
    <img class="d-block mx-auto mb-2 img-fluid" src="<?php echo e(asset('image/study-abroad1.png')); ?>" alt="study-abroad1" width="72" />
    ...
    <div class="row align-items-center fifthSec gy-4">
      ...
      <div class="col-12 col-md-6">
        <div class="card border-0 shadow-sm h-100">
          <img src="<?php echo e(asset('image/studygeorgia.jpg')); ?>" alt="studygeorgia" />
        </div>
      </div>
    </div>
    <div class="row align-items-center mb-5 gy-4">
      ...
      <div class="col-12 col-md-6 order-md-1">
        <div class="card h-100">
          <img src="<?php echo e(asset('image/uni.jpg')); ?>" alt="study" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row text-center univCard">
      <div class="col-md-4">
        <div class="card border-0 shadow-sm bg-custom p-4">
          <div class="d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('/image/graduation.png')); ?>" alt="graduation" width="40" class="me-3">
            <div>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm bg-custom1 p-4">
          <div class="d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('/image/nomad-visa.png')); ?>" alt="graduation" width="40" class="me-3">
            <div>
      ...
      <div class="col-md-4">
        <div class="card border-0 shadow-sm bg-custom2 p-4">
          <div class="d-flex align-items-center justify-content-center">
            <img src="<?php echo e(asset('/image/graduate.png')); ?>" alt="graduation" width="40" class="me-3">
            <div>
...
<?php /**PATH /home/u647397843/domains/univs.in/public_html/app/myproject/resources/views/home.blade.php ENDPATH**/ ?>